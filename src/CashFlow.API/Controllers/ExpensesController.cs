...
namespace CashFlow.API.Controllers
{
    ...
    {
        [HttpPost]
        [ProducesResponseType(typeof(ResponseRegisterdExpenseJson), StatusCodes.Status201Created)]
        ...
        [HttpGet]
        [ProducesResponseType(typeof(ResponseRegisterdExpenseJson), StatusCodes.Status200OK)]
