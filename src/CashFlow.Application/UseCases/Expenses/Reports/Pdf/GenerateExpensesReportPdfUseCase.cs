...
namespace CashFlow.Application.UseCases.Expenses.Reports.Pdf
{
    public class GenerateExpensesReportPdfUseCase : IGenerateExpensesReportPdfUseCase
    {
        ...
        public GenerateExpensesReportPdfUseCase(IExpensesReadonlyRepository repository)
        {
            ...
            // Resolvendo as Fonts que irá ser usado no arquivo PDF
        ...
        public async Task<byte[]> Execute(DateOnly month)
        {
            ...
            if (expenses.Count == 0)
            {
                Console.WriteLine($"Nenhuma despesa encontrada para {month:yyyy-MM}");
                return [];
            }
            ...
            // Método para separar em paragrafos
        ...
        private Document CreateDocument(DateOnly month)
        {
            ...
            document.Info.Author = "Igor Monteiro";
        ...
        private void CreateHeaderWithProfilePhotoAndName(Section page)
        {
            ...
            var phrase = row.Cells[1].AddParagraph("Hey, First User");
            phrase.Format.Font = new Font { Name = FontHelper.RALEWAY_BLACK, Size = 16 };
            phrase.Format.Alignment = ParagraphAlignment.Center;
        }
        ...
        private void CreateTotalSpentSection(Section page, DateOnly month, decimal totalExpense)
        {
            ...
            paragraph.AddFormattedText(
                $"{totalExpense:N2} {CURRENT_SYMBOL}",
        ...
        {
            cell.AddParagraph($"-{amount} {CURRENT_SYMBOL}");
            cell.Format.Font = new Font
            {
                Name = FontHelper.WORKSANS_REGULAR,
                Size = 14,
        ...
        {
            var pdfRender = new PdfDocumentRenderer { Document = document };

            pdfRender.RenderDocument();

            using var file = new MemoryStream();
            pdfRender.PdfDocument.Save(file);
